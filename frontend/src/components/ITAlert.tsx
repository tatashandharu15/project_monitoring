        ...
        <div className="flex flex-col items-center text-center">
          ...
          <div className="flex gap-3 w-full">
            ...
            <button
              ...
              className="flex-1 px-4 py-2.5 bg-green-600 text-white rounded-xl font-medium hover:bg-green-700 shadow-lg shadow-green-600/20 transition-all hover:scale-[1.02]"
            >
              Lihat Detail
            </button>
          </div>
